...
public class CBlockTags {
    ...
    /**
     * A tag that defines which blocks can support {@link Feature}s checking {@link Feature#isSoil(Block)}.
     */
    public static final Tag.Identified<Block> FEATURE_SUPPORTERS_SOIL = register("feature_supporters_soil");
    /**
     * A tag that defines which blocks can support {@link Feature}s checking {@link Feature#isStone(Block)}.
     */
